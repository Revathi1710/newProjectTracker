...
const BannerSection = () => {
  ...
  // Sync input field if URL changes externally
  useEffect(() => {
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    // Update the URL: this triggers the parent component to re-fetch
    setSearchParams({ 
      ...Object.fromEntries(searchParams), // keep existing params like category
      search: inputValue,
    ...
    <section className="relative pt-24 pb-32 px-4 background-banner border-b border-white/10">
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-extrabold px-8 py-3 rounded-xl transition-all active:scale-95 shadow-lg shadow-blue-200">
            SEARCH
          </button>
        </form>
      </div>
